...
profile()async{
  ...
  if (sharedPreferences.getInt('role') == 1 || sharedPreferences.getInt('role') == 4) {
    item = [];
    return item;
  }else{

    var id =  sharedPreferences.getString('id');
  var user = await FirebaseFirestore.instance.collection('students').where('id' , isEqualTo:id ).get();
