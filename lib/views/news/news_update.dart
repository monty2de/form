...
class _NewsUpdateState extends State<NewsUpdate> {
  ...
  late TextEditingController bodyController =
      new TextEditingController(text: this.widget.news.body);
  late TextEditingController titleController =
      new TextEditingController(text: this.widget.news.title);

  Future store(String title, body) async {
    var item =
        FirebaseFirestore.instance.collection('news').doc(this.widget.news.id);
    await item.set({
