  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(child: Text('SectionPillars - Perement')),
      ),
      body: Container(
        ...
        child: Center(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              InkWell(
                child: Text(
                  ' اللجنة العلمية ',style: TextStyle(
            fontSize: 30,
            ...
            color: Colors.black
             ...
             InkWell(
                child: Text(
                  '  لجنة ضمان الجودة ',style: TextStyle(
            fontSize: 30,
            fontWeight: FontWeight.w600,
            color: Colors.black
          ),
             ...
             InkWell(
                child: Text(
                  ' لجنة شؤون الطلبة  ',style: TextStyle(
            fontSize: 30,
            fontWeight: FontWeight.w600,
            color: Colors.black
          ),
